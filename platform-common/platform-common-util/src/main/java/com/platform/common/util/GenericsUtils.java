...
public class GenericsUtils {
    ...
    /**
     * 通过反射,获得方法输入参数第index个输入参数的所有泛型参数的实际类型. 如: public void add(Map<String, Buyer> maps,
     * List<String> names){}
     * 
     * @param method Method 方法
     * @param index int 第几个输入参数
    ...
    /**
     * 通过反射,获得方法输入参数第一个输入参数的所有泛型参数的实际类型. <br>
